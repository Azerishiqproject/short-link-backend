...
const supportMessageSchema = new mongoose_1.Schema({
    threadId: { type: mongoose_1.Schema.Types.ObjectId, ref: "SupportThread", required: true, index: true },
...
exports.SupportMessage = mongoose_1.default.models.SupportMessage || mongoose_1.default.model("SupportMessage", supportMessageSchema);
