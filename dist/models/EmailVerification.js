...
const emailVerificationSchema = new mongoose_1.Schema({
    ...
    referrerId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: false },
...
exports.EmailVerification = mongoose_1.default.models.EmailVerification || mongoose_1.default.model("EmailVerification", emailVerificationSchema);
